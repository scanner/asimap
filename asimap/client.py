...
class Authenticated(BaseClientHandler):
    ...
    def do_copy(self, cmd):
        ...
        try:
            ...
            self.log.error("do_copy: Unable to generate src and dst uid lists. Exception: %s, src_uids: %s, dst_uids: %s" % (str(e), str(src_uids), str(dst_uids)))
            raise e
