[
  ...
  [
    ...
    "A999 UID SEARCH IMAPSearch('and', [IMAPSearch('message_set'), IMAPSearch('uid')])"
  ],
  [
    "A202 list ~/Mail/ %\r\n",
    "A202 LIST \"~/Mail\" \"%\""
  ...
  [
    ...
    "A282 SEARCH IMAPSearch('and', [IMAPSearch('keyword', keyword = \"\\Flagged\"), IMAPSearch('since', date = \"1994-02-01 00:00:00+00:00\"), IMAPSearch('not', search_key = IMAPSearch('header', header = \"from\", string = \"smith\"))])"
  ],
  [
    "A282 SEARCH OR FLAGGED SINCE 1-Feb-1994 NOT FROM \"Smith\"\r\n",
    "A282 SEARCH IMAPSearch('and', [IMAPSearch('or', [IMAPSearch('keyword', keyword = \"\\Flagged\"), IMAPSearch('since', date = \"1994-02-01 00:00:00+00:00\")]), IMAPSearch('not', search_key = IMAPSearch('header', header = \"from\", string = \"smith\"))])"
  ],
  [
    "A282 SEARCH (OR FLAGGED 1:3,4,5,6) SINCE 1-Feb-1994 NOT FROM \"Smith\"\r\n",
    "A282 SEARCH IMAPSearch('and', [IMAPSearch('or', [IMAPSearch('keyword', keyword = \"\\Flagged\"), IMAPSearch('message_set')]), IMAPSearch('since', date = \"1994-02-01 00:00:00+00:00\"), IMAPSearch('not', search_key = IMAPSearch('header', header = \"from\", string = \"smith\"))])"
  ],
  [
    "a002 noop\r\n",
    "a002 NOOP"
