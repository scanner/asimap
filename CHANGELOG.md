...
- Support for POP3S (POP3 over TLS) server, enabled via `--enable-pop3` flag or `ENABLE_POP3` env var

## [2.4.1] - 2026-03-09

### Fixed

- Replace unmaintained `docopt` with `docopt-ng` to eliminate `SyntaxWarning` on Python 3.13
